...
--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "customer_receipt_allocations" ADD CONSTRAINT "receipt_allocations_receipt_event_fk" FOREIGN KEY ("receipt_event_id") REFERENCES "public"."party_ledger_events"("id") ON DELETE restrict ON UPDATE no action;
