...
CREATE TYPE "public"."cash_txn_status" AS ENUM('posted', 'reversed');--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "cash_txns" (
	...
	"payment_mode" text,
	"reference_no" text,
	"status" "cash_txn_status" DEFAULT 'posted' NOT NULL,
	"remarks" text,
	"created_by" uuid,
	"approved_by" uuid,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "cash_txns" ADD CONSTRAINT "cash_txns_approved_by_users_id_fk" FOREIGN KEY ("approved_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
