...
<template>
  <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh;">
    <form class="card" style="width: 320px;" @submit.prevent="handleSubmit">
      ...
      <input v-model="email" type="email" required style="width: 100%; padding: 8px; margin-bottom: 12px; border: 1px solid var(--color-border); border-radius: 6px;">
      <label style="display: block; font-size: 12px; margin-bottom: 4px;">Password</label>
      <input v-model="password" type="password" required style="width: 100%; padding: 8px; margin-bottom: 16px; border: 1px solid var(--color-border); border-radius: 6px;">
