...
//   1. server/repositories/inventory.repo.ts   — Drizzle queries only
//   2. server/services/inventory.service.ts    — business logic, calls LedgerService
//      inside a db.transaction() for anything that posts to the ledger
//   3. server/api/inventory/index.get.ts + index.post.ts — thin route handlers
...
<template>
  <div>
    <h1 style="font-size: 20px; margin-bottom: 12px;">Inventory</h1>
