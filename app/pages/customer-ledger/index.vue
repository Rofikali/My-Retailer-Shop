...
async function postReceipt() {
  ...
  try {
    const result = await $fetch<{ voucherNo: string }>('/api/party-ledger/payments', { method: 'POST', body: { partyType: 'customer', partyId: selectedCustomerId.value, ...form } })
