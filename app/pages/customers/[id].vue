...
//   1. server/repositories/customers.repo.ts   — Drizzle queries only
//   2. server/services/customers.service.ts    — business logic, calls LedgerService
//      inside a db.transaction() for anything that posts to the ledger
//   3. server/api/customers/index.get.ts + index.post.ts — thin route handlers
...
<template>
  <div>
    <h1 style="font-size: 20px; margin-bottom: 12px;">Customer Ledger</h1>
