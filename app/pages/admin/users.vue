...
//   1. server/repositories/users.repo.ts   — Drizzle queries only
//   2. server/services/users.service.ts    — business logic, calls LedgerService
//      inside a db.transaction() for anything that posts to the ledger
//   3. server/api/users/index.get.ts + index.post.ts — thin route handlers
...
<template>
  <div>
    <h1 style="font-size: 20px; margin-bottom: 12px;">User Management</h1>
