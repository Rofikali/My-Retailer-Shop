...
//   1. server/repositories/sales.repo.ts   — Drizzle queries only
//   2. server/services/sales.service.ts    — business logic, calls LedgerService
//      inside a db.transaction() for anything that posts to the ledger
//   3. server/api/sales/index.get.ts + index.post.ts — thin route handlers
...
<template>
  <div>
    <h1 style="font-size: 20px; margin-bottom: 12px;">Sales</h1>
