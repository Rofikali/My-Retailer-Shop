...
//   1. server/repositories/expenses.repo.ts   — Drizzle queries only
//   2. server/services/expenses.service.ts    — business logic, calls LedgerService
//      inside a db.transaction() for anything that posts to the ledger
//   3. server/api/expenses/index.get.ts + index.post.ts — thin route handlers
...
<template>
  <div>
    <h1 style="font-size: 20px; margin-bottom: 12px;">Expenses</h1>
